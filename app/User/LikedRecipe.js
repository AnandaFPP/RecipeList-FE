...
const LikedRecipe = () => {
    ...
    const getData = () => {
        axios.get(`http://172.20.10.2:8008/likeds`)
            .then((res) => {
    ...
    const handleDelete = (likeds_id) => {
        axios.delete(`http://172.20.10.2:8008/likeds/${likeds_id}`)
            .then(() => {
                            ...
                            >
                                <View style={styles.modalView}>
                                    ...
                                    <HStack mt={5} style={{ marginLeft: 'auto', marginRight: 'auto' }}>
                                        ...
                                        <Button backgroundColor={'red.600'} w={20} onPress={() => handleDelete(data.likeds_id)} >Hapus</Button>
                                    </HStack>
                                </View>
                            </Modal>
                        </View>
